...
export const roofers: Roofer[] = [
  {
    ...
    metaDescription:
      'Texas Roofing Experts provides professional roofing services in Dallas-Fort Worth. Specializing in residential and commercial roofing, repairs, and replacements.',
    metaKeywords: [
  ...
  },
  {
    ...
    owner: 'Robert Garcia',
    metaDescription:
      'Lone Star Roofing provides professional roofing services in Houston, TX. Specializing in residential roofing, metal roofs, and roof inspections.',
    metaKeywords: [
      'Lone Star Roofing',
      'Houston roofer',
      'metal roofing',
  ...
  },
  {
    ...
    metaDescription:
      'Austin Roof Pros provides professional roofing services in Austin, TX. Specializing in residential roofing, tile roofs, and roof repairs.',
    metaKeywords: [
      'Austin Roof Pros',
      'Austin roofer',
      'tile roofing',
