...
const formHelpContent = [
  {
    ...
    answer:
      "Your address helps us find the best local roofing professionals in your area who are familiar with your neighborhood's specific roofing needs and regulations.",
  },
  {
    question: 'What types of roofing projects can I request?',
    answer:
      'We connect you with professionals for all roofing needs including repairs, full replacements, inspections after storms, and new construction projects.',
  },
  {
    question: 'How quickly will I be contacted?',
    answer:
      'Most homeowners receive their first response from a qualified roofer within 24 hours of submitting their request.',
  },
];
...
export function RoofingForm({ onSubmit, className }: RoofingFormProps) {
  ...
  return (
    <div className={cn('w-full h-full flex flex-col', className)}>
      ...
      {/* Wrap all form steps in a flex-grow container to fill available height */}
      <div className="flex-grow flex flex-col">
        ...
        >
          ...
          <FormNavigation onNext={nextStep} onPrev={prevStep} nextDisabled={!formData.projectType} />
        </FormStep>
        ...
        >
          ...
          <FormNavigation onNext={nextStep} onPrev={prevStep} nextDisabled={!formData.timeframe} />
        </FormStep>
        ...
        {/* Step 5: Thank You */}
        <FormStep title="" isActive={step === 5} isTransitioning={isTransitioning}>
          <FormSuccess
