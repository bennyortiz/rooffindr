  ...
  return (
    ...
    >
        ...
        <CarouselContent className="h-full">
          {isLoading ? (
            ...
            Array.from({ length: 3 }).map((_, index) => (
              <CarouselItem key={`skeleton-${index}`} className="md:basis-1/2 lg:basis-1/3 h-full">
            ...
            // Actual content
            roofers.map((roofer) => (
              <CarouselItem key={roofer.id} className="md:basis-1/2 lg:basis-1/3 h-full">
                <div className="p-1 h-full">
      ...
      <div className="text-center mt-10">
        <Button variant="outline" className="mx-auto border-primary text-primary hover:bg-primary/10" asChild>
