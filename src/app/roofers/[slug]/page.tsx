        ...
        <Container>
          <div className="max-w-3xl mx-auto text-center py-20">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              The roofing professional you're looking for could not be found. Please check the URL
              and try again.
            </p>
          </div>
        </Container>
                  ...
                  <div className="flex text-yellow-400">
                    {[...Array(5)].map((_, i) => (
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        fill="currentColor"
                        className={`w-5 h-5 ${i < Math.floor(roofer.rating) ? 'text-yellow-400' : 'text-gray-300'}`}
                      >
                        <path
                          fillRule="evenodd"
                ...
                <div className="p-6">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p>
                            {roofer.address.city}, {roofer.address.state} {roofer.address.zipCode}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  {roofer.businessHours && (
                    <div>
                      ...
                      <div className="space-y-1">{formatBusinessHours()}</div>
                    </div>
                  )}
                </div>
              </div>
