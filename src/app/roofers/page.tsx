...
export default function RoofersPage() {
  ...
  const allServices = Array.from(new Set(roofers.flatMap((roofer) => roofer.services))).sort();
  ...
  const filteredRoofers = roofers.filter((roofer) => {
    ...
    const matchesCity = selectedCity === '' || roofer.cities.includes(selectedCity);
        ...
        data={{
          itemListElement: roofers.map((roofer, index) => ({
            ...
            item: {
              ...
              name: roofer.name,
              image: roofer.image,
              url: `${siteConfig.url}/roofers/${roofer.slug}`,
        ...
        <Container>
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Explore our directory of verified roofing professionals across Texas. Compare
          ...
          {filteredRoofers.length > 0 ? (
            ...
            <div className="text-center py-12 bg-white rounded-lg shadow-sm">
              ...
              <p className="text-muted-foreground mb-6">
                We couldn't find any roofing professionals matching your filters. Please try
      ...
      <Section bgColor="bg-primary/10" className="py-16">
        <Container>
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Fill out our simple form and we'll match you with the best roofing professionals for
